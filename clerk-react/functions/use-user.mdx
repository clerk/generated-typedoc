...
| `user`       | <code>undefined \| null \| [UserResource](/docs/references/javascript/user)</code> | The `User` object for the current user. If the user isn't signed in, `user` will be `null`.                              |
