...
| <a id="setactive"></a> `setActive` | <code>undefined \| (setActiveParams) => Promise\<void\></code>                          | A function that sets the active session.                                                                                 |
| <a id="signup"></a> `signUp`       | <code>undefined \| [SignUpResource](../../types/interfaces/sign-up-resource.mdx)</code> | An object that contains the current sign-up attempt status and methods to create a new sign-up attempt.                  |
