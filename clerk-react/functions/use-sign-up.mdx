...
| <a id="setactive"></a> `setActive` | `undefined` \| (`setActiveParams`) => `Promise`\<`void`\>                      | A function that sets the active session.                                                                                 |
| <a id="signup"></a> `signUp`       | `undefined` \| [`SignUpResource`](../../types/interfaces/sign-up-resource.mdx) | An object that contains the current sign-up attempt status and methods to create a new sign-up attempt.                  |
