...
| `setActive` | <code>undefined \| <code>([setActiveParams](/docs/references/javascript/types/set-active-params)) => Promise\<void\></code></code> | A function that sets the active session.                                                                                 |
