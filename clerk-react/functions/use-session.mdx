...
| <a id="session"></a> `session`       | <code>undefined \| null \| [SignedInSessionResource](../../types/type-aliases/signed-in-session-resource.mdx)</code> | Holds the current active session for the user.                                                                           |
