...
| <a id="session"></a> `session`       | `undefined` \| `null` \| [`SignedInSessionResource`](../../types/type-aliases/signed-in-session-resource.mdx) | Holds the current active session for the user.                                                                           |
