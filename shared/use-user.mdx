...
| `user` | `undefined` | The `User` object for the current user. If the user isn't signed in, `user` will be `null`. |
</Tab>
<Tab>
| Name | Type | Description |
| ------ | ------ | ------ |
...
| `user` | [`UserResource`](/docs/references/javascript/user) | The `User` object for the current user. If the user isn't signed in, `user` will be `null`. |
</Tab>
</Tabs>
