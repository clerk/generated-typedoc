...
| <a id="data"></a> `data` | `T`[] | An array that contains the fetched data. For example, for the `memberships` attribute, data will be an array of [`OrganizationMembership`](/docs/references/javascript/types/organization-membership) objects. |
...
| <a id="revalidate"></a> `revalidate` | () => `Promise`\<`void`\> | A function that triggers a revalidation of the current page. |
| <a id="setdata"></a> `setData` | `Infinite` *extends* `true` ? `CacheSetter`\<(`undefined` \| [`ClerkPaginatedResponse`](../../../../types/interfaces/clerk-paginated-response.mdx)\<`T`\>)[]\> : `CacheSetter`\<`undefined` \| [`ClerkPaginatedResponse`](../../../../types/interfaces/clerk-paginated-response.mdx)\<`T`\>\> | A function that allows you to set the data manually. |
