...
| <a id="sessions"></a> `sessions`   | <code>undefined \| [SessionResource](../../../types/interfaces/session-resource.mdx)[]</code> | A list of sessions that have been registered on the client device.                                                       |
