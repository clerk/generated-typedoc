...
| <a id="issignedin"></a> `isSignedIn` | <code>undefined \| boolean</code>              | A boolean that returns `true` if the user is signed in.                                                                         |
| <a id="user"></a> `user`             | <code>undefined \| null \| UserResource</code> | The [`User`](/docs/references/javascript/user) object for the current user. If the user isn't signed in, `user` will be `null`. |
